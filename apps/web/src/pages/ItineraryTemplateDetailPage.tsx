  ...
  useEffect(() => {
    ...
    if (hasMissingRouteData) {
      ...
      for (const stop of dayOrderedStops.slice(1)) {
        ...
        recoveredRoute[recoveredRoute.length - 1]!.segmentId = stop.segmentId ?? undefined;
        recoveredRoute[recoveredRoute.length - 1]!.segmentVersionId = stop.segmentVersionId ?? undefined;
      }
