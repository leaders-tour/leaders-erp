      ...
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <SectionHeader
            ...
            description={
              policy
                ? 'ruleType·제목·조건·금액을 관리합니다. 장거리·야간열차는 조건부 추가/할인 규칙에서 수량 기준으로 횟수 비례형을 설정합니다.'
                : '정책을 불러오는 중…'
            }
          />
        </div>
              ...
              <Card className="rounded-[28px] border border-slate-200 bg-white p-6 shadow-2xl" role="dialog" aria-modal="true">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    ...
                    <p className="mt-1 text-xs text-slate-500">ruleType, 제목, 조건, 금액을 입력합니다. 장거리·야간열차는 조건부 추가/할인에서 수량 기준으로 설정합니다.</p>
                  </div>
