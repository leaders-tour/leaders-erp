            ...
            <fieldset className="grid gap-2">
              ...
              <div className="flex gap-4">
                <label className="flex items-center gap-2 text-sm">
                  <input type="radio" name="blockType" checked={blockType === 'STAY'} onChange={() => setBlockType('STAY')} />
                  연박 (같은 목적지에서 2~3일)
                </label>
                <label className="flex items-center gap-2 text-sm">
                  <input type="radio" name="blockType" checked={blockType === 'TRANSFER'} onChange={() => setBlockType('TRANSFER')} />
                  야간열차 (출발지→도착지 이동형)
                </label>
              </div>
            </fieldset>
          ...
          <div className="flex gap-2">
            <Button
              ...
              onClick={async () => {
                ...
                navigate(`/multi-day-blocks/${stayId}`);
              }}
            >
              {updating ? '저장 중...' : '저장'}
            </Button>
