            ...
            {navItems.map((item) => (
              <div key={item.path} className="relative group">
                ...
                {item.children && item.children.length > 0 ? (
                  <div className="invisible pointer-events-none absolute left-0 top-full z-30 mt-2 min-w-[180px] rounded-xl border border-slate-200 bg-white p-1 opacity-0 shadow-lg transition group-hover:visible group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:visible group-focus-within:pointer-events-auto group-focus-within:opacity-100">
