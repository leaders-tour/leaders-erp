...
export function fromBuilderDraft(snapshot: EstimateBuilderDraftSnapshot): EstimateDocumentData {
  ...
  return {
    ...
    pickupPlaceType: snapshot.pickupPlaceType,
    pickupPlaceCustomText: snapshot.pickupPlaceCustomText || null,
    dropPlaceType: snapshot.dropPlaceType,
    dropPlaceCustomText: snapshot.dropPlaceCustomText || null,
