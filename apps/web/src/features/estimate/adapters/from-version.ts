...
export function fromVersion(version: PlanVersionDetail): EstimateDocumentData {
  ...
  return {
    ...
    pickupDate: meta?.pickupDate ?? null,
    pickupTime: meta?.pickupTime ?? null,
    dropDate: meta?.dropDate ?? null,
    dropTime: meta?.dropTime ?? null,
    pickupPlaceType: meta?.pickupPlaceType ?? null,
    pickupPlaceCustomText: meta?.pickupPlaceCustomText ?? null,
    dropPlaceType: meta?.dropPlaceType ?? null,
    dropPlaceCustomText: meta?.dropPlaceCustomText ?? null,
