 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ExtractConsultationForm($rawText: String!) {\n  extractConsultationForm(rawText: $rawText) {\n    leaderName\n    headcountTotal\n    headcountMale\n    headcountFemale\n    regionSetId\n    regionName\n    travelStartDate\n    travelEndDate\n    totalDays\n    vehicleType\n    flightInDate\n    flightInTime\n    flightOutDate\n    flightOutTime\n    movementIntensity\n    lodgingLevel\n    specialNote\n    remark\n    warnings\n    recommendedTemplateId\n    recommendedTemplateName\n    recommendedTemplateReason\n  }\n}"): (typeof documents)["mutation ExtractConsultationForm($rawText: String!) {\n  extractConsultationForm(rawText: $rawText) {\n    leaderName\n    headcountTotal\n    headcountMale\n    headcountFemale\n    regionSetId\n    regionName\n    travelStartDate\n    travelEndDate\n    totalDays\n    vehicleType\n    flightInDate\n    flightInTime\n    flightOutDate\n    flightOutTime\n    movementIntensity\n    lodgingLevel\n    specialNote\n    remark\n    warnings\n    recommendedTemplateId\n    recommendedTemplateName\n    recommendedTemplateReason\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query RegionSets {\n  regionSets {\n    id\n    signature\n    name\n    isActive\n    items {\n      id\n      regionId\n      sortOrder\n      region {\n        id\n        name\n      }\n    }\n  }\n}\n\nquery RegionSetsForAdmin($includeInactive: Boolean) {\n  regionSets(includeInactive: $includeInactive) {\n    id\n    signature\n    name\n    isActive\n    deletedAt\n    items {\n      id\n      regionId\n      sortOrder\n      region {\n        id\n        name\n      }\n    }\n  }\n}\n\nmutation CreateRegionSet($input: RegionSetCreateInput!) {\n  createRegionSet(input: $input) {\n    id\n    signature\n    name\n    items {\n      regionId\n      region {\n        id\n        name\n      }\n    }\n  }\n}"): (typeof documents)["query RegionSets {\n  regionSets {\n    id\n    signature\n    name\n    isActive\n    items {\n      id\n      regionId\n      sortOrder\n      region {\n        id\n        name\n      }\n    }\n  }\n}\n\nquery RegionSetsForAdmin($includeInactive: Boolean) {\n  regionSets(includeInactive: $includeInactive) {\n    id\n    signature\n    name\n    isActive\n    deletedAt\n    items {\n      id\n      regionId\n      sortOrder\n      region {\n        id\n        name\n      }\n    }\n  }\n}\n\nmutation CreateRegionSet($input: RegionSetCreateInput!) {\n  createRegionSet(input: $input) {\n    id\n    signature\n    name\n    items {\n      regionId\n      region {\n        id\n        name\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
