  ...
  async replaceStops(planTemplateId: string, stops: PlanTemplateCreateDto['planStops']) {
    ...
    await this.prisma.planTemplateStop.createMany({
      data: stops.map((stop) => ({
        ...
        overnightStayId: stop.overnightStayId ?? stop.multiDayBlockId ?? undefined,
        overnightStayDayOrder: stop.overnightStayDayOrder ?? stop.multiDayBlockDayOrder ?? undefined,
        overnightStayConnectionId: stop.overnightStayConnectionId ?? stop.multiDayBlockConnectionId ?? undefined,
        overnightStayConnectionVersionId:
          stop.overnightStayConnectionVersionId ?? stop.multiDayBlockConnectionVersionId ?? undefined,
        multiDayBlockId: stop.multiDayBlockId ?? stop.overnightStayId ?? undefined,
        multiDayBlockDayOrder: stop.multiDayBlockDayOrder ?? stop.overnightStayDayOrder ?? undefined,
        multiDayBlockConnectionId: stop.multiDayBlockConnectionId ?? stop.overnightStayConnectionId ?? undefined,
        multiDayBlockConnectionVersionId:
          stop.multiDayBlockConnectionVersionId ?? stop.overnightStayConnectionVersionId ?? undefined,
